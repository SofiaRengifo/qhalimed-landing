      ...
      <div>
        ...
        <div className="historia">
          <div className="container">
            <div className="row">
              <div className="col-lg-7 order-lg-2 d-flex align-content-between flex-wrap">
                <div className="d-none d-sm-flex caracteristicas">
                  <div data-aos="fade-left"><i className="fa-solid fa-heart-pulse fa-2xl"></i><h5>Diagnóstico preciso</h5></div>
                  <div data-aos="fade-left" data-aos-delay="200"><i className="fa-solid fa-user-doctor fa-2xl"></i><h5>Seguimiento continuo</h5></div>
                  <div data-aos="fade-left" data-aos-delay="400" className="d-none d-xl-block"><i className="fa-solid fa-laptop-medical fa-2xl"></i><h5>Innovación constante</h5></div>
                  <div data-aos="fade-left" data-aos-delay="600"><i className="fa-solid fa-hospital fa-2xl"></i><h5>Resultados confiables</h5></div>
                </div>
               ...
               <div className="col-lg-5 order-lg-1 align-content-end">
        ...
        <div style={{ background: "#EDF2F1" }}>
          <div className="container">
            <div className="row py-6">
              <div className="col-md-6 mision" data-aos="fade-right">
                <h2>Misión</h2>
              ...
              <div className="col-md-6 mt-5 mt-md-0 mision"data-aos="fade-left">
                <h2>Visión</h2>
                <div className="mision-content">                 
